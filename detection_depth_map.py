...
def stereo_depth_map(rectified_pair, detection_results):
    ...
    try:
        x1 = (detection_results.detections[0].bounding_box.origin_x) - 50
        x2 = (x1 + detection_results.detections[0].bounding_box.width) + 100
        y1 = detection_results.detections[0].bounding_box.origin_y - 50
        y2 = y1 + detection_results.detections[0].bounding_box.height  + 100
...
#   cap.set(cv2.CAP_PROP_FRAME_HEIGHT, height)
  ...
  detection_options = processor.DetectionOptions(
      max_results=1, score_threshold=0.05)

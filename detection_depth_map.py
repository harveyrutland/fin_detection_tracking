...
def stereo_depth_map(rectified_pair, detection_results):
    ...
    x1 = detection_results.detections[0].bounding_box[0].origin_x
    x2 = x1 + detection_results.detections[0].bounding_box[0].width
    y1 = detection_results.detections[0].bounding_box[0].origin_y
    y2 = x1 + detection_results.detections[0].bounding_box[0].height

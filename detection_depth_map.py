...
def stereo_depth_map(rectified_pair, detection_results):
    ...
    try:
        ...
        x2 = (x1 + detection_results.detections[0].bounding_box.width)+10
        y1 = detection_results.detections[0].bounding_box.origin_y -10
        y2 = x1 + detection_results.detections[0].bounding_box.height +10
